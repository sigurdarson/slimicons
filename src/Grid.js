...
var SvgComponent = function SvgComponent(props) {
  return /*#__PURE__*/React.createElement("svg", _extends({
    ...
    d: "M13.5 17.25C13.5 16.553 13.5 16.2045 13.5576 15.9147C13.7944 14.7247 14.7247 13.7944 15.9147 13.5576C16.2045 13.5 16.553 13.5 17.25 13.5C17.947 13.5 18.2955 13.5 18.5853 13.5576C19.7753 13.7944 20.7056 14.7247 20.9424 15.9147C21 16.2045 21 16.553 21 17.25C21 17.947 21 18.2955 20.9424 18.5853C20.7056 19.7753 19.7753 20.7056 18.5853 20.9424C18.2955 21 17.947 21 17.25 21C16.553 21 16.2045 21 15.9147 20.9424C14.7247 20.7056 13.7944 19.7753 13.5576 18.5853C13.5 18.2955 13.5 17.947 13.5 17.25Z",
    stroke: props.color || "#000",
    strokeWidth: 1.5
  }));
};
